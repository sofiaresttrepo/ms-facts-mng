    ...
    return (
        <div>
            <TextField
                ...
                label={T.translate("shark_attack.metadata.createdBy")}
                id="createdBy"
                name="createdBy"
            ...
            <TextField
                className={`mt-8 mb-16 ${fullHalfStyle}`}
                label={T.translate("shark_attack.metadata.createdAt")}
                id="createdAt"
                name="createdAt"
            ...
            <TextField
                className={`mt-8 mb-16 ${fullHalfStyle}`}
                label={T.translate("shark_attack.metadata.updatedBy")}
                id="updatedBy"
                name="updatedBy"
            ...
            <TextField
                className={`mt-8 mb-16 ${fullHalfStyle}`}
                label={T.translate("shark_attack.metadata.updatedAt")}
                id="updatedAt"
                name="updatedAt"
